...
All editor tooling (tree-sitter, TextMate, highlights) is generated from `lang/lang.go` via `go generate`. See [GRAMMAR-DESIGN.md](GRAMMAR-DESIGN.md) for the full rationale.
...
The tree-sitter grammar, highlight queries, and TextMate grammar are all **generated** from `lang/lang.go` via `go generate ./pkg/chisel/lang/`. See [GRAMMAR-DESIGN.md](GRAMMAR-DESIGN.md) for the full rationale.

The generator produces:
- `grammar.js` — operator precedence and keywords from `lang.Operators` and `lang.Settings`; structural rules from a template
- `queries/highlights.scm` — shape, function, method, color, and constant names from `lang.go` registries
- `queries/folds.scm` and `queries/indents.scm` — folding and indentation rules
- `chisel.tmLanguage.json` — TextMate grammar for VS Code / Sublime

### Testing

```bash
cd pkg/chisel/editors/tree-sitter-chisel
...
```
tree-sitter-chisel/
  grammar.js          ← generated from lang/lang.go
  src/
    parser.c          ← generated by tree-sitter generate
  queries/
    highlights.scm    ← generated from lang/lang.go
    folds.scm         ← generated from lang/lang.go
    indents.scm       ← generated from lang/lang.go
  package.json
```
